            ...
            <div class="widget">
                ...
                <div class="widget-content">
                    ...
                    <div class="widget-content padding">
                        {{ Form::open(['route' => 'rendicions.store', 'class' => 'form-horizontal', 'role' => 'form', 'autocomplete' => 'off']) }}
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    {{ Form::text('tj', '', ['id' => 'tj', 'name' => 'tj', 'class' => 'form-control input-lg', 'placeholder' => 'Ingrese numero de tj']) }}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    {{ Form::text('periodo', '', ['id' => 'periodo', 'name' => 'periodo', 'class' => 'form-control input-lg', 'placeholder' => 'Ingrese numero de periodo']) }}
                                </div>
                            </div>
