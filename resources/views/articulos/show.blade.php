							...
							<div class="widget-content">
								...
								<div class="widget-content padding">
									...
									{{ Form::hidden('_method', 'DELETE') }}
										...
										<div class="form-group">
											<label for="input-text" class="col-sm-2 control-label">Precio</label>
											<div class="col-sm-2">
												{{ $articulo->precio}}
											</div>
											<label for="input-text" class="col-sm-2 control-label">Stock Actual</label>
											<div class="col-sm-2">
												{{ $articulo->stock_actual}}
											</div>
											<label for="input-text" class="col-sm-2 control-label">Stock Minimo</label>
											<div class="col-sm-2">
